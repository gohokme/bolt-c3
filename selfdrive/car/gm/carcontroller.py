...
from selfdrive.car.gm.values import DBC, CanBus, CarControllerParams, Buttons
    ...
    if self.CP.openpilotLongitudinalControl:
      ...
      if (self.frame - self.last_button_frame) * DT_CTRL > 0.04:
        if self.cancel_counter > CAMERA_CANCEL_DELAY_FRAMES:
          ...
          can_sends.append(gmcan.create_buttons(self.packer_pt, CanBus.CAMERA, CS.buttons_counter, Buttons.CANCEL))
